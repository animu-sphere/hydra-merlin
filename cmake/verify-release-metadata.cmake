...
if((_hgi_vulkan_bridge_enabled AND
    NOT MERLIN_EXPECTED_HGI_VULKAN_BRIDGE) OR
   (NOT _hgi_vulkan_bridge_enabled AND
    MERLIN_EXPECTED_HGI_VULKAN_BRIDGE))
  message(FATAL_ERROR
    "metadata HgiVulkan bridge flag ${_hgi_vulkan_bridge_enabled} != ${MERLIN_EXPECTED_HGI_VULKAN_BRIDGE}")
endif()
if(MERLIN_EXPECTED_HGI_VULKAN_BRIDGE AND
...
if(MERLIN_EXPECTED_VIEWPORT AND NOT MERLIN_EXPECTED_VULKAN AND
   NOT MERLIN_EXPECTED_METAL)
  message(FATAL_ERROR "viewport metadata requires a native GPU backend")
endif()
...
if(NOT _slang_required STREQUAL "2026.8" OR
   NOT _shader_abi_version EQUAL 5)
...
if(MERLIN_EXPECTED_VIEWPORT)
  set(_viewport_product_found FALSE)
  math(EXPR _runtime_product_last "${_runtime_product_count} - 1")
  foreach(_runtime_product_index RANGE 0 ${_runtime_product_last})
    string(JSON _runtime_product GET "${_merlin_metadata}"
           packaging runtime_products ${_runtime_product_index})
    if(_runtime_product STREQUAL "merlin-viewport")
      set(_viewport_product_found TRUE)
    endif()
  endforeach()
  if(NOT _viewport_product_found)
...
if(MERLIN_EXPECTED_HYDRA2)
  ...
  set(_hydra_product_found FALSE)
  math(EXPR _runtime_product_last "${_runtime_product_count} - 1")
  foreach(_runtime_product_index RANGE 0 ${_runtime_product_last})
    string(JSON _runtime_product GET "${_merlin_metadata}"
           packaging runtime_products ${_runtime_product_index})
    if(_runtime_product STREQUAL "hdMerlin")
      set(_hydra_product_found TRUE)
    endif()
  endforeach()
  if(NOT _hydra_product_found)
