...
- Saved in-session viewport benchmark baselines with live CPU/GPU percentage
  comparison, adjustable regression and hitch thresholds, and red hitch markers
  over the rolling host/GPU timing plots. Hydra viewport benchmark JSON now
  retains GPU totals and averages as well.
