...
string(JSON gaussian_resources GET "${json}" fixture gaussian_resource_count)
string(JSON gaussian_particles GET "${json}" fixture gaussian_particle_count)
if(NOT gaussian_resources EQUAL 0 OR NOT gaussian_particles EQUAL 0)
  message(FATAL_ERROR "reference fixture unexpectedly contains Gaussians")
endif()
...
foreach(stage gaussian_preparation gaussian_attribute_upload
              gaussian_prepared_upload gaussian_raster)
  string(JSON stage_type TYPE "${json}" baselines 0 stages_ns "${stage}")
  if(NOT stage_type STREQUAL "OBJECT")
    message(FATAL_ERROR "missing Gaussian timing stage ${stage}")
  endif()
endforeach()
...
assert_counter(0 gaussian_draw_count 0)
assert_counter(0 gaussian_attribute_upload_bytes 0)
assert_counter(0 gaussian_attribute_copy_range_count 0)
assert_counter(0 gaussian_attribute_generation_count 0)
assert_counter(0 gaussian_upload_bytes 0)
...
assert_counter(1 gaussian_draw_count 0)
assert_counter(1 gaussian_attribute_upload_bytes 0)
assert_counter(1 gaussian_attribute_copy_range_count 0)
assert_counter(1 gaussian_attribute_generation_count 0)
assert_counter(1 gaussian_upload_bytes 0)
