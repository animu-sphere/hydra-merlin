...
OST 0.17.0 or newer is the operational baseline. It supplies atomic completion
...
regenerating project-owned source. OST 0.17.0 provides `ost renderer adopt` for
