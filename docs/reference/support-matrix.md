...
| HgiVulkan host presentation bridge | Planned for v0.13.0: Hgi-owned targets, selected-AOV GPU copy, Tier 0 CPU fallback, resize/frames-in-flight safety, and capability/rejection telemetry. Direct same-device sharing is a separately evidence-gated v0.13.1 capability. |
